	...
	<header class="header-section">
		<div class="container">
			...
			<a href="index.html" class="site-logo">
				<img src="img/clinick-logo.png" alt="">
			</a>
			<!-- responsive -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-sm-6 fact">
					<i style="color: #5ad5e5;" class="flaticon-003-tooth-3"></i>
					<h2>531</h2>
					<p>X-rays</p>
				</div>
				<div class="col-md-3 col-sm-6 fact">
					<i style="color: #5ad5e5;" class="flaticon-002-toothbrush-1"></i>
					<h2>14K</h2>
					<p>Tooth Brushes</p>
				</div>
				<div class="col-md-3 col-sm-6 fact">
					<i style="color: #5ad5e5;" class="flaticon-030-tooth"></i>
					<h2>678</h2>
					<p>Extractions</p>
				</div>
				<div class="col-md-3 col-sm-6 fact">
					<i style="color: #5ad5e5;" class="flaticon-023-tooth-1"></i>
					<h2>2134</h2>
					<p>Happy Pacients</p>
				</div>
			</div>
